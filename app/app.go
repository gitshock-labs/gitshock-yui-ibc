...
import (
	...
	claimsmodule "gitshock/x/claims"
	claimsmodulekeeper "gitshock/x/claims/keeper"
	claimsmoduletypes "gitshock/x/claims/types"
	dexmodule "gitshock/x/dex"
	dexmodulekeeper "gitshock/x/dex/keeper"
	dexmoduletypes "gitshock/x/dex/types"
...
func New(
	...
	*/
	...
	app.GitshockKeeper = *gitshockmodulekeeper.NewKeeper(
		appCodec,
		keys[gitshockmoduletypes.StoreKey],
		keys[gitshockmoduletypes.MemStoreKey],
		app.GetSubspace(gitshockmoduletypes.ModuleName),
	)
	gitshockModule := gitshockmodule.NewAppModule(appCodec, app.GitshockKeeper, app.AccountKeeper, app.BankKeeper)
